...
const content = `{
    ...
    "enable_session_timeout": ${process.env.ENABLE_SESSION_TIMEOUT || true},
    "storage_session_time_key": "${process.env.STORAGE_SESSION_TIME_KEY || ''}",
    "expiry_time_in_minute": ${+process.env.EXPIRY_TIME_IN_MINUTE || 30},
    "warning_alert_timeout_in_minute": ${+process.env.WARNING_ALERT_TIMEOUT_IN_MINUTE || 1}
  }`;
